...
// Define types outside the main component
interface SkillItemType {
  label: string;
  content: string;
}

// Define interface for typography styles
interface TypographyStylesType {
  textTransform: string;
  fontWeight: string | number;
  letterSpacing: string;
  [key: string]: string | number; // Allow for additional style properties
}
...
// Helper function to get icon color - moved outside component
const getIconColor = (
  skill: string,
...
// SkillItem component - moved outside the main component
const SkillItem = ({
  skill,
  index,
  categoryInView,
    ...
    >
      {Icon && (
        <Icon
          ...
          style={{ color: getIconColor(skill, theme, mounted) }}
        />
      )}
...
// SkillCategory component - moved outside the main component
const SkillCategory = ({
  skill,
  index,
  theme,
