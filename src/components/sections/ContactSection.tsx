...
export default function ContactSection() {
  ...
  return (
    <section
      id="contact"
      className="min-h-screen flex flex-col justify-between items-center px-6"
    >
      <div className="flex flex-col items-center justify-center flex-1 w-full">
        ...
        <p className="max-w-xl text-center mb-8 text-lg">
          ...
          out? Click the button below to send me an email. I'm always excited to
          take on new projects and explore fresh opportunities in software
